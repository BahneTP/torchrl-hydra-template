...
src/
  ...
  algorithms/
    ...
    a2c/
      ...
      README.md             — theory, pseudocode, W&B benchmark table
    common/
      pixel_control.py      — TorchRL adapter shared by pixel-control agents
      pixel_networks.py, rl.py — shared pixel-control network/RL helpers
    der/, spr/, bbf/, sac_bbf/
      *.py                  — DER/SPR/SR-SPR/BBF/SAC-BBF learning cores
  replay/
    prioritized.py, sum_tree.py — NumPy prioritized replay implementation
  environments/
    ...
    atari_wrappers.py       — Atari max-and-skip / episodic-life TorchRL transform
    atari_wrappers.py       — Atari 100K max-and-skip/life-loss preprocessing wrappers
  trainers/
...
configs/
  ...
  algorithm/{der,spr,sr_spr,bbf,sac_bbf}.yaml — DER/SPR/SR-SPR/BBF/SAC-BBF HPs
  ...
  experiment/atari100k/{der,spr,sr_spr,bbf,sac_bbf}/jamesbond.yaml
...
python src/train.py experiment=atari100k/der/jamesbond # Atari 100K DER
python src/train.py experiment=atari100k/spr/jamesbond # Atari 100K SPR
python src/train.py experiment=atari100k/bbf/jamesbond # Atari 100K BBF
