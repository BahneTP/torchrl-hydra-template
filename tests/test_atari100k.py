...
@pytest.mark.parametrize(
    ...
    [
        ...
        "atari100k/spr/jamesbond",
        "atari100k/sr_spr/jamesbond",
        "atari100k/bbf/jamesbond",
        "atari100k/sac_bbf/jamesbond",
    ],
)
...
def test_smoke_der_jamesbond():
    """DER on Jamesbond: tiny replay/update path through the real TorchRL adapter."""
...
def test_atari100k_life_loss_resets_policy_stack_flag():
    from src.algorithms.common.pixel_control import _is_init
...
def test_atari_algorithm_seed_controls_agent_and_replay():
    ...
    algo = PixelControlAlgorithm(seed=123)
...
def test_replay_prefetch_is_enabled_only_for_fixed_schedule_spr(
    ...
    from src.algorithms import bbf, der, sac_bbf, spr
    from src.algorithms.bbf import algorithm as bbf_algorithm
    from src.algorithms.der import algorithm as der_algorithm
    from src.algorithms.sac_bbf import algorithm as sac_bbf_algorithm
    from src.algorithms.spr import algorithm as spr_algorithm
    ...
    algorithm_modules = {
        "DERAlgorithm": der_algorithm,
        "SPRAlgorithm": spr_algorithm,
        "SRSPRAlgorithm": spr_algorithm,
        "BBFAlgorithm": bbf_algorithm,
        "SACBBFAlgorithm": sac_bbf_algorithm,
    }
    algorithm = getattr(algorithm_modules[algorithm_class], algorithm_class)(
...
def test_spr_prefetch_reuses_the_background_sample():
    from src.algorithms.spr.algorithm import SPRAlgorithm
...
def test_sr_spr_reference_preset_values_compose():
    cfg = load_experiment_cfg("atari100k/sr_spr/jamesbond", BASE_OVERRIDES)
...
def test_sac_bbf_train_step_includes_policy_metrics():
    from src.algorithms.sac_bbf.sac_bbf import SACBBFAgent, SACBBFConfig
