...
RUN_ROOT="${RUN_ROOT:-logs/bbf-testing/lora/lora_lr_1e_8_without_shrink_perturb_jamesbond_seed1_${STAMP}}"
RESULTS_CSV="$RUN_ROOT/results.csv"
SUMMARY_CSV="$RUN_ROOT/summary.csv"
ALGORITHM="bbf"
VARIANT="resnet18_layer2_lora_lr_1e_8_without_shrink_perturb"
game="Jamesbond"
seed=1
...
echo "Starting BBF ResNet18 layer2 LoRA lr=1e-8 without shrink-and-perturb ${game} seed ${seed} on GPU ${GPU}"
set +e
