...
RUN_ROOT="${RUN_ROOT:-logs/lora/new_lora/der_resnet18_layer2_lora_r4_a8_lr_1e_8_${RUN_SUFFIX}_${STAMP}}"
RESULTS_CSV="$RUN_ROOT/results.csv"
SUMMARY_CSV="$RUN_ROOT/summary.csv"
VARIANT="resnet18_lora_layer2_r4_a8_lr_1e_8"
...
for game in "${games[@]}"; do
  for seed in "${seeds[@]}"; do
    ...
    echo "Starting DER ResNet18 LoRA layer2 rank=4 alpha=8 lr=1e-8 ${game} seed ${seed} on GPU ${GPU}"
    set +e
